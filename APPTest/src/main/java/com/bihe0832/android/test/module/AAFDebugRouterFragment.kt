...
class AAFDebugRouterFragment : com.bihe0832.android.common.debug.module.DebugRouterFragment() {
    ...
    override fun getRouterList(): ArrayList<RouterItem> {
        return ArrayList<RouterItem>().apply {
            ...
            add(RouterItem("zixie://ztbsfeedback?url=https%3A%2F%2Fsupport.qq.com%2Fproduct%2F290858"))
            ...
            add(RouterItem("zixie://ztbsfeedback?url=" + URLUtils.encode("https://support.qq.com/embed/phone/290858/large/")))

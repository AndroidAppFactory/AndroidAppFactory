package com.bihe0832.android.lib.pinyin.code;
...
public final class PinyinData {
    ...
    public static final int PINYIN_CODE_1_OFFSET = 7000;

    public static final int PINYIN_CODE_2_OFFSET = 7000 * 2;

    public static final int[] BIT_MASKS = new int[]{1, 2, 4, 8, 16, 32, 64, 128};

    public static final int PADDING_MASK = 256;
    //CHECKSTYLE:OFF

...
public class SuperAPPContants {
    ...
    public static final String APK_PACKAGE_NAME_OPPO_MARKET = "com.oppo.market";
    public static final String APK_PACKAGE_NAME_HUAWEI_MARKET = "com.huawei.appmarket";

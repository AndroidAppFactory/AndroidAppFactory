...
public class CommonDialogNew extends Dialog {
    ...
    public CommonDialogNew setOnClickListener(OnDialogListener onClickBottomListener) {
        this.onClickBottomListener = onClickBottomListener;
        return this;
    }

    public CommonDialogNew setMessage(String message) {
        this.mContentString = message;
        return this;
    }


    public CommonDialogNew setTitle(String title) {
        this.mTitleString = title;
        return this;
    }


    public CommonDialogNew setPositive(String positive) {
        this.mPositiveButtonString = positive;
        return this;
    }

    public CommonDialogNew setNegtive(String negtive) {
        this.mNegativeButtonString = negtive;
        return this;
    }

    public CommonDialogNew setContentMaxLine(int maxLine) {
        this.maxLine = maxLine;
        return this;
    }

    public CommonDialogNew setShouldCanceled(boolean flag) {
        shouldCanceled = flag;
        return this;
    }

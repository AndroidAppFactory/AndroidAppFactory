package com.bihe0832.android.lib.audio.wave
...
private val MaxSpikeWidthDp: Dp = 10.dp
private val MinSpikePaddingDp: Dp = 0.dp
private val MaxSpikePaddingDp: Dp = 10.dp
private val MinSpikeRadiusDp: Dp = 0.dp
private val MaxSpikeRadiusDp: Dp = 5.dp
...
fun AudioWaveform(
    ...
    progressBrush: Brush = SolidColor(Color.LightGray),
            ...
            .pointerInteropFilter {
                return@pointerInteropFilter when (it.action) {
                    ...
                    MotionEvent.ACTION_MOVE -> {
                        if (canScroll && it.x in 0F..canvasSize.width) {

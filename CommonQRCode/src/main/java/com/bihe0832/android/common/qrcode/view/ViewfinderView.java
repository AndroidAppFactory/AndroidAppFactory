package com.bihe0832.android.common.qrcode.view;
/*
...
import static com.bihe0832.android.common.qrcode.view.ViewfinderView.FrameGravity.CENTER;
...
public class ViewfinderView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        cornerColor = array.getColor(R.styleable.ViewfinderView_cornerColor,
                ContextCompat.getColor(context, R.color.corner_color));
        laserColor = array.getColor(R.styleable.ViewfinderView_laserColor,
                ContextCompat.getColor(context, R.color.laser_color));
        ...
        labelTextColor = array.getColor(R.styleable.ViewfinderView_labelTextColor,
                ContextCompat.getColor(context, R.color.viewfinder_text));
        ...
        scannerLineMoveDistance = (int) array.getDimension(R.styleable.ViewfinderView_scannerLineMoveDistance,
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        ZLog.d("onLayout" + getWidth() + "," + getHeight());
    ...
    private void initFrame(int width, int height) {
        ...
        frame = new Rect((int) leftOffsets, (int) topOffsets, (int) leftOffsets + frameWidth,
                (int) topOffsets + frameHeight);
    }
    ...
    private void drawTextInfo(Canvas canvas, Rect frame) {
        if (!TextUtils.isEmpty(labelText)) {
            ...
            StaticLayout staticLayout = new StaticLayout(labelText, textPaint, labelTextWidth,
    ...
    private void drawCorner(Canvas canvas, Rect frame) {
        ...
        //右下
        canvas.drawRect(frame.right - cornerRectWidth, frame.bottom - cornerRectHeight, frame.right, frame.bottom,
                paint);
        canvas.drawRect(frame.right - cornerRectHeight, frame.bottom - cornerRectWidth, frame.right, frame.bottom,
                paint);
    }
    ...
    private void drawGridScanner(Canvas canvas, Rect frame) {
        ...
        LinearGradient linearGradient = new LinearGradient(frame.left + frame.width() / 2, startY,
                frame.left + frame.width() / 2, scannerStart, new int[]{shadeColor(laserColor), laserColor},
                new float[]{0, 1f}, LinearGradient.TileMode.CLAMP);
        //给画笔设置着色器
        paint.setShader(linearGradient);

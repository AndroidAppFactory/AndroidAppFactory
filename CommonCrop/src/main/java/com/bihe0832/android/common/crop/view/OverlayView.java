...
public class OverlayView extends View {
...

    {
        mTouchPointThreshold = getResources().getDimensionPixelSize(
                R.dimen.crop_default_crop_rect_corner_touch_threshold);
        ...
        mCropRectCornerTouchAreaLineLength = getResources().getDimensionPixelSize(
                R.dimen.crop_default_crop_rect_corner_touch_area_line_length);
    }
...
//        }
    ...
    private void initCropFrameStyle(@NonNull TypedArray a) {
        ...
        int cropFrameColor = a.getColor(R.styleable.CropView_ucrop_frame_color,
                getResources().getColor(R.color.crop_default_crop_frame));
    ...
    private void initCropGridStyle(@NonNull TypedArray a) {
        ...
        int cropGridColor = a.getColor(R.styleable.CropView_grid_color,
                getResources().getColor(R.color.crop_default_crop_grid));
        ...
        mCropGridColumnCount = a.getInt(R.styleable.CropView_grid_column_count,

...
public class AspectRatioTextView extends AppCompatTextView {
    ...
    private void init(@NonNull TypedArray a) {
        ...
        mAspectRatioTitle = a.getString(R.styleable.AspectRatioTextView_artv_ratio_title);
        mAspectRatioX = a.getFloat(R.styleable.AspectRatioTextView_artv_ratio_x,
                CropImageView.SOURCE_IMAGE_ASPECT_RATIO);
        mAspectRatioY = a.getFloat(R.styleable.AspectRatioTextView_artv_ratio_y,
                CropImageView.SOURCE_IMAGE_ASPECT_RATIO);

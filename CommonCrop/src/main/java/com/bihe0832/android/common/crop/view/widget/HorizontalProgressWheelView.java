package com.bihe0832.android.common.crop.view.widget;
...
public class HorizontalProgressWheelView extends View {
    ...
    private void init() {
        ...
        mProgressLineHeight = getContext().getResources()
                .getDimensionPixelSize(R.dimen.crop_height_horizontal_wheel_progress_line);
        mProgressLineMargin = getContext().getResources()
                .getDimensionPixelSize(R.dimen.crop_margin_horizontal_wheel_progress_line);
        ...
        mProgressMiddleLinePaint.setStrokeWidth(
                getContext().getResources().getDimensionPixelSize(R.dimen.crop_width_middle_wheel_progress_line));
    }

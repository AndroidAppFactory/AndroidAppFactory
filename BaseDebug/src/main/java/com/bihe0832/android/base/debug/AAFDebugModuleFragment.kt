        ...
        return ArrayList<CardBaseModule>().apply {
            ...
            add(
                getDebugFragmentItemData(
                    "下载及安装 Download 调试",
                    DebugDownloadFragment::class.java
                )
            )
            add(
                getDebugFragmentItemData(
                    "Dialog、底部弹出Activity 调试",
                    DebugDialogFragment::class.java
                )
            )
            add(
                getDebugFragmentItemData(
                    "文件（Zip、assets 等）、配置、DB操作调试",
                    DebugFileFragment::class.java
                )
            )
            ...
            add(
                getDebugFragmentItemData(
                    "权限 Permission 调试",
                    DebugPermissionFragment::class.java
                )
            )
            ...
            add(
                getDebugFragmentItemData(
                    "定时任务、阻塞任务、延迟任务",
                    DebugEnqueueFragment::class.java
                )
            )
            add(
                getDebugFragmentItemData(
                    "协程、多线程、前台服务",
                    DebugThreadAndCoroutinesFragment::class.java
                )
            )
            add(
                getDebugFragmentItemData(
                    "摇一摇、震动等测试",
                    DebugShakeAndVibratorFragment::class.java
                )
            )
            ...
            add(
                getDebugFragmentItemData(
                    "UI（点击区、TextView、自定义View）测试",
                    DebugBaseViewFragment::class.java
                )
            )
            ...
            add(
                getDebugFragmentItemData(
                    "UI（换肤、哀悼日、多语言、前后台等）测试",
                    DebugUIFragment::class.java
                )
            )

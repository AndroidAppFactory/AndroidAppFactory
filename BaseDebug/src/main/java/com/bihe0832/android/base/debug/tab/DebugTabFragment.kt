...
class DebugTabFragment : BaseDebugListFragment() {
    ...
    override fun getDataList(): ArrayList<CardBaseModule> {
        return ArrayList<CardBaseModule>().apply {
            add(getDebugItem("DebugCommonTabActivity", View.OnClickListener { startActivityWithException(DebugCommonTabActivity::class.java) }))
            add(getDebugItem("DebugSegmentTabActivity", View.OnClickListener { startActivityWithException(DebugSegmentTabActivity::class.java) }))
            add(getDebugItem("DebugSlidingTabActivity", View.OnClickListener { startActivityWithException(DebugSlidingTabActivity::class.java) }))

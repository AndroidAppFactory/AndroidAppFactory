...
fun DebugComposeDialogView() {
    ...
    DebugContent {
        ...
        DebugItem("分享APK") { startActivityWithException(activity, ShareAPPActivity::class.java) }
//        DebugItem("底部分享Activity") {
//            startActivityWithException(
//                activity,

...
private fun testMsg(activity: Activity) {
    val messageData =
        "{" + "        \"id\": \"1\"," + "        \"type\": \"text\"," + "        \"title\": \"置顶应用下载公告带通知栏通知\"," + "        \"content\": \"1. 修复下载期间偶现Crash，提升稳定性 <BR> 2. 优化下载及使用用户体验\"," + "        \"should_top\": \"1\"," + "        \"expire_date\": \"-1\"," + "        \"action\": \"https://android.bihe0832.com/doc/summary/links.html\"," + "        \"isNotify\": \"1\"," + "        \"showFace\": 2," + "        \"create_date\": \"202307200600\"" + "    }"

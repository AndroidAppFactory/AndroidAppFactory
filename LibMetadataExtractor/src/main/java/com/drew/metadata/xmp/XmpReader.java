...
{
    @NotNull
    private static final String XMP_JPEG_PREAMBLE = "https://ns.adobe.com/xap/1.0/\0";
    @NotNull
    private static final String XMP_EXTENSION_JPEG_PREAMBLE = "https://ns.adobe.com/xmp/extension/\0";
    @NotNull
    private static final String SCHEMA_XMP_NOTES = "https://ns.adobe.com/xmp/note/";
    @NotNull
    ...
    private static byte[] processExtendedXMPChunk(@NotNull Metadata metadata, @NotNull byte[] segmentBytes, @NotNull String extendedXMPGUID, @Nullable byte[] extendedXMPBuffer)
    {
        ...
        if (segmentLength >= totalOffset) {
            try {
                /*
                 * The chunk contains:
                 * - A null-terminated signature string of "https://ns.adobe.com/xmp/extension/".

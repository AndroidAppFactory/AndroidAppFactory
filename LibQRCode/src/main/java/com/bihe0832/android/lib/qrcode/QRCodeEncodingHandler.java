...
public final class QRCodeEncodingHandler {
    ...
    public static Bitmap createQRCode(String str, int widthAndHeight) {
        return createQRCode(str, widthAndHeight, widthAndHeight, Color.BLACK, null);
    }
    ...
    public static Bitmap createQRCode(String content, int widthPix, int heightPix, Bitmap logoBm) {
        return createQRCode(content, ErrorCorrectionLevel.M, widthPix, heightPix, Color.BLACK, logoBm, 7);
    }

    public static Bitmap createQRCode(String content, int widthPix, int heightPix, int codeColor, Bitmap logoBm) {
        if (content.length() > ERROR_CORRECTION_Level_LENGTH) {
            return createQRCode(content, ErrorCorrectionLevel.M, widthPix, heightPix, codeColor, logoBm, 7);
        } else {
            return createQRCode(content, ErrorCorrectionLevel.H, widthPix, heightPix, codeColor, logoBm, 7);
        }
    }

    public static Bitmap createQRCode(String content, ErrorCorrectionLevel errorCorrectionLevel, int widthPix,
            int heightPix, int codeColor, Bitmap logoBm, int percent) {
        try {

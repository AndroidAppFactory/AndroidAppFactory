...
public class BottomBar extends LinearLayout {
    ...
    public BottomBar addItem(final BaseBottomBarTab tab) {
        tab.getTabView().setOnClickListener(v -> {
        ...
        if (tab.getTabPosition() == mDefaultPosition) {
            mCurrentPosition = mDefaultPosition;
            tab.setSelected(true);
        } else {
            tab.setSelected(false);
        }
        tab.getTabView().setLayoutParams(mTabParams);
    ...
    public void setDefaultPosition(int postion) {
        mDefaultPosition = postion;
    }

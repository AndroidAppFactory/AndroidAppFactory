    ...
    public static Bitmap createImageFromText(
        ...
        try {
            ...
            if (!TextUtils.isEmpty(title)) {
                ...
                StaticLayout.Builder titleBuilder = StaticLayout.Builder.obtain(title, 0, title.length(),
                        titleTextPaint,
                        width - padding);
                ...
                titleStaticLayout = titleBuilder.build();
            ...
            int x = padding / 2;
            int y = (height - staticLayout.getHeight() - titleHeight - iconHeight
                    - (DisplayUtil.dip2px(
                    context, titleTopPadding + contentTopPadding))) / 2;

            if (iconHeight > 0 && icon != null) {
                canvas.save();
            ...
            canvas.save();
            canvas.translate(x, y + iconHeight + titleHeight + DisplayUtil.dip2px(
